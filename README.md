...
## UPDATE 24.02.2026
Проект закрыт обновляться не будет больше. Где-то были удалены файлы, переделаны запросы к таблицам, удалены ненужные зависимости.
Функция в function.php не совсем дописана. Но смысл можно понять.
